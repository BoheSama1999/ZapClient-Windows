...
constexpr ULONG64 OFF_LEVEL = 0x17ec494;//[Miscellaneous]->LevelName
constexpr ULONG64 OFF_LOCAL_PLAYER = 0x23e90b8; //[Miscellaneous]->LocalPlayer
constexpr ULONG64 OFF_ENTITY_LIST = 0x1f15ec8;  //[Miscellaneous]->cl_entitylist
constexpr ULONG64 OFF_NAME_INDEX = 0x38;//nameIndex
constexpr ULONG64 OFF_NAME_LIST = 0xd3503c0;//[Miscellaneous]->NameList
constexpr ULONG64 OFF_GAMEMODE = 0x02421110;//mp_gamemode
constexpr ULONG64 OFF_SQUAD_ID = 0x0344;//m_squadID
constexpr ULONG64 OFF_GLOBAL_VARS = 0x17ebf90;  //[Miscellaneous]->GlobalVars
 
// HUD
constexpr ULONG64 OFF_VIEWRENDER = 0x769b4d8; //[Miscellaneous]->ViewRender
constexpr ULONG64 OFF_VIEWMATRIX = 0x11a350;  //[Miscellaneous]->ViewMatrix
 
// Buttons
constexpr ULONG64 OFF_INATTACK = 0x0769b5d8; //[Buttons]->in_attack
constexpr ULONG64 OFF_IN_JUMP = 0x0769b6e0;  //[Buttons]->in_jump
constexpr ULONG64 OFF_IN_DUCK = 0x0769b7e8;  //[Buttons]->in_duck
constexpr ULONG64 OFF_IN_FORWARD = 0x0769b528;   //[Buttons]->in_forward
constexpr ULONG64 OFF_IN_BACKWARD = 0x0769b550;//[Buttons]->in_backward
...
constexpr ULONG64 OFF_SKY_DIVE_STATUS = 0x4724;   //m_skydiveState
constexpr ULONG64 OFF_DUCK_STATUS = 0x2a60;   // m_duckState
...
constexpr ULONG64 OFF_PROJECTILESCALE = 0x1ec4 + 0x8; //projectile_gravity_scale + [WeaponSettingsMeta]base
constexpr ULONG64 OFF_PROJECTILESPEED = 0x1ec4; //projectile_launch_speed + [WeaponSettingsMeta]base
...
constexpr ULONG64 OFF_VIEWMODELS = 0x2d98;   //m_hViewModels
...
constexpr ULONG64 OFF_GLOW_HIGHLIGHTS = 0xb13c620; //0xb13b520
